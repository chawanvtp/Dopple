...
export default function VotePage({
  ...
  const linkIfAddress = (content: string) => {
    if (isAddress(content) && chainId) {
      ...
      return <ExternalLink href={getBSCscanLink(content, 'address')}>{commonName}</ExternalLink>
    }
    ...
    <PageWrapper gap="lg" justify="center">
      ...
      <ProposalInfo gap="lg" justify="start">
        ...
        <AutoColumn gap="md">
          ...
          <ExternalLink
            href={proposalData?.proposer && chainId ? getBSCscanLink(proposalData?.proposer, 'address') : ''}
          >
