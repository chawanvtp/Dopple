      ...
      <TopSection gap="md">
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>Twindex Governance</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                  Twindex tokens represent voting shares in Twindex governance. You can vote on each proposal yourself
              ...
              <ExternalLink
                ...
                target="_blank"
              >
                <TYPE.white fontSize={14}>Read more about Twindex governance</TYPE.white>
              </ExternalLink> 
              */}
            </AutoColumn>
          </CardSection>
          ...
          <RowBetween>
            ...
            {userDelegatee && userDelegatee !== ZERO_ADDRESS ? (
              <RowFixed>
                ...
                <AddressButton>
                  <StyledExternalLink href={getBSCscanLink(userDelegatee, 'address')} style={{ margin: '0 4px' }}>
