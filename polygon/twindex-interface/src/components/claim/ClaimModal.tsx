        ...
        <ContentWrapper gap="lg">
            ...
            <CardSection gap="sm">
              ...
              {userClaimData?.flags?.isUser && (
                <RowBetween>
                  ...
                  <TYPE.subHeader color="white">{USER_AMOUNT} Twindex </TYPE.subHeader>
                </RowBetween>
              )}
            </CardSection>
          </ModalUpper>
          <AutoColumn gap="md" style={{ padding: '1rem', paddingTop: '0' }} justify="center">
            <TYPE.subHeader fontWeight={500}>
              As a member of the Twindex community you may claim Twindex to be used for voting and governance. <br />{' '}
              <br />
              {/* <ExternalLink href="https://uniswap.org/blog/uni">Read more about Twindex</ExternalLink> */}
            </TYPE.subHeader>
            <ButtonPrimary
        ...
        <ConfirmOrLoadingWrapper activeBG={true}>
          ...
          <AutoColumn gap="100px" justify={'center'}>
            ...
            {attempting && claimSubmitted && !claimConfirmed && chainId && claimTxn?.hash && (
              <ExternalLink href={getBSCscanLink(claimTxn?.hash, 'transaction')} style={{ zIndex: 99 }}>
