      ...
      {!attempting && (
        <ContentWrapper gap="lg">
          <ModalUpper>
            ...
            <CardSection gap="md">
              <RowBetween>
                <TYPE.white fontWeight={500}>Claim Twindex Token</TYPE.white>
                <CloseIcon onClick={wrappedOnDismiss} style={{ zIndex: 99 }} stroke="white" />
              </RowBetween>
              <TYPE.white fontWeight={700} fontSize={36}>
                {unclaimedAmount?.toFixed(0, { groupSeparator: ',' } ?? '-')} Twindex
              </TYPE.white>
            </CardSection>
            <Break />
          </ModalUpper>
          <AutoColumn gap="md" style={{ padding: '1rem', paddingTop: '0' }} justify="center">
            <TYPE.subHeader fontWeight={500}>
              Enter an address to trigger a Twindex claim. If the address has any claimable Twindex it will be sent to
              them on submission.
            </TYPE.subHeader>
        ...
        <ConfirmOrLoadingWrapper activeBG={true}>
          ...
          <AutoColumn gap="100px" justify={'center'}>
            ...
            {attempting && hash && !claimConfirmed && chainId && hash && (
              <ExternalLink href={getBSCscanLink(hash, 'transaction')} style={{ zIndex: 99 }}>
