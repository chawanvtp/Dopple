...
function validateSolidityTypeInstance(value, solidityType) {
    !JSBI.greaterThanOrEqual(value, ZERO) ?
        ...
        invariant(false) :
        void 0!JSBI.lessThanOrEqual(value, SOLIDITY_TYPE_MAXIMA[solidityType]) ?
        process.env.NODE_ENV !== 'production' ?
        invariant(false, value + ' is not a ' + solidityType + '.') :
        invariant(false) :
        void 0
...
function sortedInsert(items, add, maxSize, comparator) {
    ...
    process.env.NODE_ENV !== 'production' ?
        ...
        invariant(false): void 0 // this is an invariant because the interface cannot return multiple removed items if items.length exceeds maxSize
...
var Token = /*#__PURE__*/ (function(_Currency) {
        ...
        _proto.sortsBefore = function sortsBefore(other) {
            ...
            process.env.NODE_ENV !== 'production' ?
                ...
                invariant(false): void 0!(this.address !== other.address) ?
                process.env.NODE_ENV !== 'production' ?
...
var Pair = /*#__PURE__*/ (function() {
    ...
    _proto.getLiquidityValue = function getLiquidityValue(token, totalSupply, liquidity, feeOn, kLast) {
        ...
        !this.involvesToken(token) ?
            ...
            invariant(false, 'TOKEN') :
            invariant(false) :
            void 0!totalSupply.token.equals(this.liquidityToken) ?
            process.env.NODE_ENV !== 'production' ?
            invariant(false, 'TOTAL_SUPPLY') :
            invariant(false) :
            void 0!liquidity.token.equals(this.liquidityToken) ?
            process.env.NODE_ENV !== 'production' ?
            invariant(false, 'LIQUIDITY') :
            invariant(false) :
            void 0!JSBI.lessThanOrEqual(liquidity.raw, totalSupply.raw) ?
            process.env.NODE_ENV !== 'production' ?
            invariant(false, 'LIQUIDITY') :
            invariant(false) :
            void 0
...
var Route = /*#__PURE__*/ (function() {
    function Route(pairs, input, output) {
        ...
        process.env.NODE_ENV !== 'production' ?
            ...
            invariant(false): void 0!pairs.every(function(pair) {
        ...
        for (var _iterator = _createForOfIteratorHelperLoose(pairs.entries()), _step; !(_step = _iterator()).done;) {
            var _step$value = _step.value,
                i = _step$value[0],
                pair = _step$value[1]
            var currentInput = path[i] !(currentInput.equals(pair.token0) || currentInput.equals(pair.token1)) ?
                process.env.NODE_ENV !== 'production' ?
...
function inputOutputComparator(a, b) {
    ...
    !currencyEquals(a.inputAmount.currency, b.inputAmount.currency) ?
        ...
        invariant(false) :
        void 0!currencyEquals(a.outputAmount.currency, b.outputAmount.currency) ?
        process.env.NODE_ENV !== 'production' ?
...
var Trade = /*#__PURE__*/ (function() {
    ...
    Trade.bestTradeExactIn = function bestTradeExactIn(
            ...
            process.env.NODE_ENV !== 'production' ?
                invariant(false, 'PAIRS') :
                invariant(false): void 0!(maxHops > 0) ? (process.env.NODE_ENV !== 'production' ? invariant(false, 'MAX_HOPS') : invariant(false)) : void 0!(originalAmountIn === currencyAmountIn || currentPairs.length > 0) ?
                process.env.NODE_ENV !== 'production' ?
    ...
    Trade.bestTradeExactOut = function bestTradeExactOut(
        ...
        process.env.NODE_ENV !== 'production' ?
            invariant(false, 'PAIRS') :
            invariant(false): void 0!(maxHops > 0) ? (process.env.NODE_ENV !== 'production' ? invariant(false, 'MAX_HOPS') : invariant(false)) : void 0!(originalAmountOut === currencyAmountOut || currentPairs.length > 0) ?
            process.env.NODE_ENV !== 'production' ?
            invariant(false, 'INVALID_RECURSION') :
            invariant(false) :
            void 0
...
var Router = /*#__PURE__*/ (function() {
    ...
    Router.swapCallParameters = function swapCallParameters(trade, options) {
        ...
        var etherOut = trade.outputAmount.currency === ETHER // the router does not support both ether in and out
            ...
            invariant(false) :
            void 0!(!('ttl' in options) || options.ttl > 0) ?
            process.env.NODE_ENV !== 'production' ?
            invariant(false, 'TTL') :
            invariant(false) :
            void 0
...
var Fetcher = /*#__PURE__*/ (function() {
    ...
    Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
        try {
            if (provider === undefined) provider = getDefaultProvider(getNetwork(tokenA.chainId)) !(tokenA.chainId === tokenB.chainId) ?
                process.env.NODE_ENV !== 'production' ?
                invariant(false, 'CHAIN_ID') :
                invariant(false) :
                void 0
