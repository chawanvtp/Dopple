...
var FACTORY_ADDRESS = '0x4E66Fda7820c53C1a2F601F84918C375205Eac3E'
var INIT_CODE_HASH = '0x652b5a4fa6b1efd55c9821e56279c871f9999588a5472d22ab78b8ec61e2521e'
...
function validateSolidityTypeInstance(value, solidityType) {
    !JSBI.greaterThanOrEqual(value, ZERO) ? invariant(false, value + ' is not a ' + solidityType + '.') : void 0!JSBI.lessThanOrEqual(value, SOLIDITY_TYPE_MAXIMA[solidityType]) ?
...
function validateAndParseAddress(address$1) {
    try {
        ...
        warning(address$1 === checksummedAddress, address$1 + ' is not checksummed.'): void 0
...
var Token = /*#__PURE__*/ (function(_Currency) {
        ...
        _proto.sortsBefore = function sortsBefore(other) {
            !(this.chainId === other.chainId) ? invariant(false, 'CHAIN_IDS'): void 0!(this.address !== other.address) ? invariant(false, 'ADDRESSES') : void 0
...
var Fraction = /*#__PURE__*/ (function() {
    ...
    _proto.toSignificant = function toSignificant(significantDigits, format, rounding) {
        ...
        !Number.isInteger(significantDigits) ? invariant(false, significantDigits + ' is not an integer.') : void 0!(significantDigits > 0) ? invariant(false, significantDigits + ' is not positive.') : void 0
        Decimal.set({
    ...
    _proto.toFixed = function toFixed(decimalPlaces, format, rounding) {
        ...
        !Number.isInteger(decimalPlaces) ? invariant(false, decimalPlaces + ' is not an integer.') : void 0!(decimalPlaces >= 0) ? invariant(false, decimalPlaces + ' is negative.') : void 0
...
var Pair = /*#__PURE__*/ (function() {
                        ...
                        (_extends3[tokens[0].address] = _extends({},
                            ...
                            ((_extends2 = {}),
                                (_extends2[tokens[1].address] = address.getCreate2Address(
                                    FACTORY_ADDRESS,
                                    solidity.keccak256(
                                        ['bytes'], [solidity.pack(['address', 'address'], [tokens[0].address, tokens[1].address])]
                                    ),
                                    INIT_CODE_HASH
                                )),
                                _extends2)
    ...
    _proto.getLiquidityMinted = function getLiquidityMinted(totalSupply, tokenAmountA, tokenAmountB) {
        ...
        var tokenAmounts = tokenAmountA.token.sortsBefore(tokenAmountB.token) // does safety checks
            ?
            [tokenAmountA, tokenAmountB] : [tokenAmountB, tokenAmountA] !(tokenAmounts[0].token.equals(this.token0) && tokenAmounts[1].token.equals(this.token1)) ?
    ...
    _proto.getLiquidityValue = function getLiquidityValue(token, totalSupply, liquidity, feeOn, kLast) {
        ...
        !this.involvesToken(token) ? invariant(false, 'TOKEN') : void 0!totalSupply.token.equals(this.liquidityToken) ? invariant(false, 'TOTAL_SUPPLY') : void 0!liquidity.token.equals(this.liquidityToken) ? invariant(false, 'LIQUIDITY') : void 0!JSBI.lessThanOrEqual(liquidity.raw, totalSupply.raw) ? invariant(false, 'LIQUIDITY') : void 0
...
var Route = /*#__PURE__*/ (function() {
    function Route(pairs, input, output) {
        !(pairs.length > 0) ? invariant(false, 'PAIRS'): void 0!pairs.every(function(pair) {
        ...
        for (var _iterator = _createForOfIteratorHelperLoose(pairs.entries()), _step; !(_step = _iterator()).done;) {
            var _step$value = _step.value,
                i = _step$value[0],
                pair = _step$value[1]
            var currentInput = path[i] !(currentInput.equals(pair.token0) || currentInput.equals(pair.token1)) ? invariant(false, 'PATH') : void 0
...
function inputOutputComparator(a, b) {
    ...
    !currencyEquals(a.inputAmount.currency, b.inputAmount.currency) ? invariant(false, 'INPUT_CURRENCY') : void 0!currencyEquals(a.outputAmount.currency, b.outputAmount.currency) ? invariant(false, 'OUTPUT_CURRENCY') : void 0
...
var Trade = /*#__PURE__*/ (function() {
    ...
    Trade.bestTradeExactIn = function bestTradeExactIn(
            ...
            !(pairs.length > 0) ? invariant(false, 'PAIRS'): void 0!(maxHops > 0) ? invariant(false, 'MAX_HOPS') : void 0!(originalAmountIn === currencyAmountIn || currentPairs.length > 0) ? invariant(false, 'INVALID_RECURSION') : void 0
            var chainId =
                currencyAmountIn instanceof TokenAmount ?
                currencyAmountIn.token.chainId :
                currencyOut instanceof Token ?
                currencyOut.chainId :
                undefined!(chainId !== undefined) ? invariant(false, 'CHAIN_ID') : void 0
    ...
    Trade.bestTradeExactOut = function bestTradeExactOut(
        ...
        !(pairs.length > 0) ? invariant(false, 'PAIRS'): void 0!(maxHops > 0) ? invariant(false, 'MAX_HOPS') : void 0!(originalAmountOut === currencyAmountOut || currentPairs.length > 0) ?
...
var Router = /*#__PURE__*/ (function() {
    ...
    Router.swapCallParameters = function swapCallParameters(trade, options) {
        ...
        var etherOut = trade.outputAmount.currency === ETHER // the router does not support both ether in and out
            ...
            !!(etherIn && etherOut) ? invariant(false, 'ETHER_IN_OUT') : void 0!(!('ttl' in options) || options.ttl > 0) ? invariant(false, 'TTL') : void 0
...
var Fetcher = /*#__PURE__*/ (function() {
    ...
    Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
        try {
            if (provider === undefined) provider = providers.getDefaultProvider(networks.getNetwork(tokenA.chainId)) !(tokenA.chainId === tokenB.chainId) ?
                'development' !== 'production' ?
